...
class FormItemProps extends ClassProps {
    ...
    var change: ScOption[js.Function4[DynamicFormSS, FormItem, JSAny, JSAny, Boolean]] = ScNone
    var changed: ScOption[js.Function3[DynamicFormSS, FormItem, JSAny, _]] = ScNone
